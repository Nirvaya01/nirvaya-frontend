  ...
  return (
    <SafeAreaView style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll}>
        ...
        <Text style={styles.subtitle}>Join Nirvaya and stay protected</Text>
        ...
        <TouchableOpacity onPress={() => router.push('/sign-in')} style={styles.footerWrap}>
...
const styles = StyleSheet.create({
  ...
  primaryButton: {
    backgroundColor: ACCENT, borderRadius: 14, paddingVertical: 15, alignItems: 'center', marginTop: 20,
